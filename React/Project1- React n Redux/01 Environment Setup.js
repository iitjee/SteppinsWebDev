...
we'll use: https://github.com/coryhouse/pluralsight-redux-starter
...
Babel-Polyfill:
few things babel can't do and babel-polyfill can do for es6->5
array.from, set, map, promise, generator functions etc.
Downsides: It's too large 50K but we can pull out whatever particula polyfill we want

babel-preset-react-hmre
it's a babel preset that wraps up a number of other libraries and settings in a single prest
...
WARNINGS: experimental and doesn't reload functional  components and container functions like mapStateTOprops
